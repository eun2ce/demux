...
import { massive, MassiveActionHandler, Migration, MigrationSequence } from "demux-postgres";
import { IDatabase } from "pg-promise";
import { NonExistentMigrationError } from "./errors";
...
export class MassiveGxcActionHandler extends MassiveActionHandler {
   ...
   public async migrate(
      ...
      const migrationRunner = new GxcMigrationRunner(
